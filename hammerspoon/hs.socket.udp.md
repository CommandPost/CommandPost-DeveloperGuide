...
| Parameters |  * fn - An optional [callback function](#setCallback) for reading data from the socket, settable here for convenience | | Returns |  * An [`hs.socket.udp`](#new) object | 
#### [server](#server)
...
| Parameters |  * port - A port number [0-65535]. Ports [1-1023] are privileged. Port 0 allows the OS to select any available port * fn - An optional [callback function](#setCallback) for reading data from the socket, settable here for convenience | | Returns |  * An [`hs.socket.udp`](#new) object | 
### Methods
...
| Parameters |  * port - A port number [0-65535]. Ports [1-1023] are privileged. Port 0 allows the OS to select any available port | | Returns |  * The [`hs.socket.udp`](#new) object or `nil` if an error occured | 
#### [pause](#pause)
...
| Parameters |  * version - An optional number containing the IP version to prefer. Anything but 4 or 6 else sets the default neutral behavior | | Returns |  * The [`hs.socket.udp`](#new) object | | Notes |  * If a DNS lookup returns only IPv4 results, the socket will automatically use IPv4 * If a DNS lookup returns only IPv6 results, the socket will automatically use IPv6 * If a DNS lookup returns both IPv4 and IPv6 results, then the protocol used depends on the configured preference | 
#### [read](#read)
...
| Parameters |  * fn - An optional callback function to process data read from the socket. `nil` or no argument clears the callback | | Returns |  * The [`hs.socket.udp`](#new) object | 
#### [setTimeout](#setTimeout)
...
| Parameters |  * timeout - A number containing the timeout duration, in seconds | | Returns |  * The [`hs.socket.udp`](#new) object | 
#### [write](#write)
