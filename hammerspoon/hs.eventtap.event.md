...
| Parameters |  * keycode - A number containing a raw keycode, taken from `hs.keycodes.map` | | Returns |  * The `hs.eventtap.event` object | | Notes |  * This method should only be used on keyboard events | 
#### [setProperty](#setProperty)
| | |
|-|-|
