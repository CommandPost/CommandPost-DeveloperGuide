...
| Parameters |  * filepath - Any kind of file or directory path, be it relative or not; or nil if an error occured |
...
| Returns |  * A table containing the list of the file's tags, or nil if an error occurred |
