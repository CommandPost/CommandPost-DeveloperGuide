...
| **Parameters**                              |  * filename - the path and name of the file to save. * filetype - optional case-insensitive string paramater specifying the file type to save (default PNG)   * PNG  - save in Portable Network Graphics (PNG) format   * TIFF - save in Tagged Image File Format (TIFF) format   * BMP  - save in Windows bitmap image (BMP) format   * GIF  - save in Graphics Image Format (GIF) format   * JPEG - save in Joint Photographic Experts Group (JPEG) format         |
| **Returns**                                 |  * Status - a boolean value indicating success (true) or failure (false)                  |
| **Notes**                                   |  * Saves image at its original size.                        |
