...
| **Notes**                                            | <ul><li><code>hs.inspect(hs.redshift.COLORRAMP)</code> from the console will show you how the table is built</li><li>the default ramp has entries from 1000K to 10000K every 100K</li></ul> |
