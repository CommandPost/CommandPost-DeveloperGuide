    ...
    <header>
      <h1><a href="hs.keycodes.md">docs</a> &raquo; hs.keycodes</h1>
        ...
        <h4 class="documentation-section">Constants</h4>
          <section id="map">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>A mapping from string representation of a key to its keycode, and vice versa.
        ...
        <h4 class="documentation-section">Functions</h4>
          <section id="currentLayout">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Gets the name of the current keyboard layout</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>A string containing the name of the current keyboard layout</li>
          ...
          <section id="currentLayoutIcon">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Gets the icon of the current keyboard layout</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>An hs.image object containing the icon, if available</li>
          ...
          <section id="currentMethod">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Get current input method</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>Name of current input method, or nil</li>
          ...
          <section id="currentSourceID">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Get or set the source id for the keyboard input source</p>
<p>Parameters:</p>
<ul>
...
<li>If no parameter is provided, returns a string containing the source id for the current keyboard layout or input method; if a parameter is provided, returns true or false specifying whether or not the input source was able to be changed.</li>
          ...
          <section id="iconForLayoutOrMethod">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Gets an hs.image object for a given keyboard layout or input method</p>
<p>Parameters:</p>
<ul>
...
<li>Not all layouts/methods have icons, so you should assume this will return nil at some point</li>
          ...
          <section id="inputSourceChanged">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Sets the function to be called when your input source (i.e. qwerty, dvorak, colemac) changes.</p>
<p>Parameters:</p>
<ul>
...
<li>Setting this will un-set functions previously registered by this function.</li>
          ...
          <section id="layouts">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Gets all of the enabled keyboard layouts that the keyboard input source can be switched to</p>
<p>Parameters:</p>
<ul>
...
<li>Only those layouts which can be explicitly switched to will be included in the table.  Keyboard layouts which are part of input methods are not included.  See <code>hs.keycodes.methods</code>.</li>
          ...
          <section id="methods">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Gets all of the enabled input methods that the keyboard input source can be switched to</p>
<p>Parameters:</p>
<ul>
...
<li>Keyboard layouts which are not part of an input method are not included in this table.  See <code>hs.keycodes.layouts</code>.</li>
          ...
          <section id="setLayout">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Changes the system keyboard layout</p>
<p>Parameters:</p>
<ul>
...
<li>A boolean, true if the layout was successfully changed, otherwise false</li>
          ...
          <section id="setMethod">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Changes the system input method</p>
<p>Parameters:</p>
<ul>
