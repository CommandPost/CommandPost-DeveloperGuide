...
#### [defaultLogLevel](#defaultloglevel)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.defaultLogLevel` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Variable                                                                                         |
...
#### [history](#history)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.history() -> list of log entries` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [historySize](#historysize)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.historySize([size]) -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [new](#new)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.new(id, loglevel) -> logger` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [printHistory](#printhistory)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.printHistory([entries[, level[, filter[, caseSensitive]]]])` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setGlobalLogLevel](#setgloballoglevel)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.setGlobalLogLevel(lvl)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setModulesLogLevel](#setmodulesloglevel)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.setModulesLogLevel(lvl)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [level](#level)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger.level` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Field                                                                                         |
...
#### [d](#d)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:d(...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [df](#df)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:df(fmt,...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [e](#e)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:e(...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [ef](#ef)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:ef(fmt,...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [f](#f)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:f(fmt,...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [getLogLevel](#getloglevel)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:getLogLevel() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [i](#i)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:i(...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [setLogLevel](#setloglevel)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:setLogLevel(loglevel)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [v](#v)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:v(...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [vf](#vf)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:vf(fmt,...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [w](#w)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:w(...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [wf](#wf)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.logger:wf(fmt,...)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
