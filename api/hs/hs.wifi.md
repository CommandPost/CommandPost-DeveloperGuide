...
| **Parameters**                                       | <ul><li>network - A string containing the SSID of the network to associate to</li><li>passphrase - A string containing the passphrase of the network</li><li>interface - An optional string containing the name of an interface (see <a href="#interfaces">hs.wifi.interfaces</a>). If not present, the default system WLAN device will be used</li></ul> |
...
| **Parameters**                                       | <ul><li>state - a boolean value indicating if the Wifi device should be powered on (true) or off (false).</li><li>interface - an optional interface name as listed in the results of <a href="#interfaces">hs.wifi.interfaces</a>.  If not present, the interface defaults to the systems default WLAN device.</li></ul> |
...
| **Parameters**                                       | <ul><li>fn        - the function to callback when the scan is completed.</li><li>interface - an optional interface name as listed in the results of <a href="#interfaces">hs.wifi.interfaces</a>.  If not present, the interface defaults to the systems default WLAN device.</li></ul> |
