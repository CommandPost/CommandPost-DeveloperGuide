...
#### [connect](#connect)
| <span style="float: left;">**Signature**</span> | <span style="float: left;">`hs.tangent.connect() -> boolean, errorMessage` </span>                                                          |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
| **Returns**                                          | <ul><li>success - `true` on success, otherwise `nil`</li><li>errorMessage - Any error messages as a string</li></ul>          |
...
| **Parameters**                                       | <ul><li>applicationName - Your application name as a string</li><li>xmlPath - Path to the Tangent XML configuration files as a string</li></ul> |
| **Returns**                                          | <ul><li>`true` on successful connection, `false` on failed connection or `nil` on error.</li></ul>          |
