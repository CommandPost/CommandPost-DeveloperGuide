...
| **Parameters**                                       | <ul><li>key - A string containing the key name of the pair * value - A string containing the value of the pair</li></ul> |
| **Returns**                                          | <ul><li>None</li></ul> |
...
| **Parameters**                                       | <ul><li>name - A string containing the name of the exception * message - A human readabke string explaining the exception</li></ul> |
| **Returns**                                          | <ul><li>None</li></ul> |
