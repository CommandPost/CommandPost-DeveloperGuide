...
#### [state_paused](#state_paused)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.state_paused` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
| **Description**                                      | Returned by `hs.itunes.getPlaybackState()` to indicates iTunes is paused                                                                                         |

#### [state_playing](#state_playing)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.state_playing` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
| **Description**                                      | Returned by `hs.itunes.getPlaybackState()` to indicates iTunes is playing                                                                                         |

#### [state_stopped](#state_stopped)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.state_stopped` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
...
#### [displayCurrentTrack](#displaycurrenttrack)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.displayCurrentTrack()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [ff](#ff)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.ff()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentAlbum](#getcurrentalbum)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getCurrentAlbum() -> string or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentArtist](#getcurrentartist)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getCurrentArtist() -> string or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentTrack](#getcurrenttrack)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getCurrentTrack() -> string or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getDuration](#getduration)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getDuration()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getPlaybackState](#getplaybackstate)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getPlaybackState()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getPosition](#getposition)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getPosition()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getVolume](#getvolume)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.getVolume()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isPlaying](#isplaying)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.isPlaying()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isRunning](#isrunning)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.isRunning()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [next](#next)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.next()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pause](#pause)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.pause()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [play](#play)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.play()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [playpause](#playpause)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.playpause()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [previous](#previous)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.previous()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [rw](#rw)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.rw()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setPosition](#setposition)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.setPosition(pos)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setVolume](#setvolume)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.setVolume(vol)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [volumeDown](#volumedown)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.volumeDown()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [volumeUp](#volumeup)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.itunes.volumeUp()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
