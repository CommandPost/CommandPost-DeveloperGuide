...
#### [state_paused](#state_paused)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.state_paused` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
| **Description**                                      | Returned by `hs.spotify.getPlaybackState()` to indicates Spotify is paused                                                                                         |

#### [state_playing](#state_playing)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.state_playing` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
| **Description**                                      | Returned by `hs.spotify.getPlaybackState()` to indicates Spotify is playing                                                                                         |

#### [state_stopped](#state_stopped)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.state_stopped` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
...
#### [displayCurrentTrack](#displaycurrenttrack)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.displayCurrentTrack()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [ff](#ff)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.ff()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentAlbum](#getcurrentalbum)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getCurrentAlbum()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentArtist](#getcurrentartist)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getCurrentArtist()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCurrentTrack](#getcurrenttrack)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getCurrentTrack()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getDuration](#getduration)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getDuration()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getPlaybackState](#getplaybackstate)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getPlaybackState()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getPosition](#getposition)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getPosition()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getVolume](#getvolume)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.getVolume()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isPlaying](#isplaying)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.isPlaying()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isRunning](#isrunning)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.isRunning()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [next](#next)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.next()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pause](#pause)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.pause()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [play](#play)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.play()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [playpause](#playpause)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.playpause()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [previous](#previous)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.previous()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [rw](#rw)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.rw` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setPosition](#setposition)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.setPosition(pos)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setVolume](#setvolume)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.setVolume(vol)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [volumeDown](#volumedown)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.volumeDown()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [volumeUp](#volumeup)
| <span style="text-align: left;">**Signature**</span> | <span style="text-align: left;">`hs.spotify.volumeUp()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
