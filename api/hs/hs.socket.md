...
#### [timeout](#timeout)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket.timeout` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Variable                                                                                         |
...
#### [parseAddress](#parseaddress)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket.parseAddress(sockaddr) -> table or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [new](#new)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket.new([fn]) -> hs.socket object` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [server](#server)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket.server(port|path[, fn]) -> hs.socket object` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [connect](#connect)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:connect({host, port}|path[, fn]) -> self or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [connected](#connected)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:connected() -> bool` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [connections](#connections)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:connections() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [disconnect](#disconnect)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:disconnect() -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [info](#info)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:info() -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [listen](#listen)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:listen(port|path) -> self or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [read](#read)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:read(delimiter[, tag]) -> self or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [receive](#receive)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:receive(delimiter[, tag]) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
| **Description**                                      | Alias for [`hs.socket:read`](#read)                                                                                         |

#### [send](#send)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:send(message[, tag]) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
| **Description**                                      | Alias for [`hs.socket:write`](#write)                                                                                         |

#### [setCallback](#setcallback)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:setCallback([fn]) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [setTimeout](#settimeout)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:setTimeout(timeout) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [startTLS](#starttls)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:startTLS([verify][, peerName]) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [write](#write)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.socket:write(message[, tag][, fn]) -> self` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
