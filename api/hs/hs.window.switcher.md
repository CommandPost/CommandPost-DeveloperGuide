    ...
    <header>
      <h1><a href="hs.window.switcher.md">docs</a> &raquo; hs.window.switcher</h1>
...
hs.hotkey.bind('alt-shift','tab','Prev window',hs.window.switcher.previousWindow,nil,hs.window.switcher.previousWindow)</code></pre>
        ...
        <h4 class="documentation-section">Variables</h4>
          <section id="ui">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Allows customization of the switcher behaviour and user interface</p>
<p>This table contains variables that you can change to customize the behaviour of the switcher and the look of the UI.
To have multiple switcher instances with different behaviour/looks, use the <code>uiPrefs</code> parameter for the constructor;
...
<li><p><code>hs.window.switcher.ui.textColor = {0.9,0.9,0.9}</code></p>
</li>
        ...
        <h4 class="documentation-section">Functions</h4>
          <section id="nextWindow">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Shows the switcher (if not yet visible) and selects the next window</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>the switcher will be dismissed (and the selected window focused) when all modifier keys are released</li>
          ...
          <section id="previousWindow">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Shows the switcher (if not yet visible) and selects the previous window</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
        ...
        <h4 class="documentation-section">Constructors</h4>
          <section id="new">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Creates a new switcher instance; it can use a windowfilter to determine which windows to show</p>
<p>Parameters:</p>
<ul>
        ...
        <h4 class="documentation-section">Methods</h4>
          <section id="next">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Shows the switcher instance (if not yet visible) and selects the next window</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>the switcher will be dismissed (and the selected window focused) when all modifier keys are released</li>
          ...
          <section id="previous">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Shows the switcher instance (if not yet visible) and selects the previous window</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
