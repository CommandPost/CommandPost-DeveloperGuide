    ...
    <header>
      <h1><a href="hs.fs.volume.md">docs</a> &raquo; hs.fs.volume</h1>
        ...
        <h4 class="documentation-section">Constants</h4>
          ...
          <section id="didRename">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>A volume changed either its name or mountpoint (or more likely, both)</p>
</td>
              </tr>
            </table>
          </section>
          ...
          <section id="willUnmount">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>A volume is about to be unmounted</p>
</td>
              </tr>
            </table>
          </section>
...
<li>The meanings of NSURLVolumeIsEjectableKey and NSURLVolumeIsRemovableKey are not generally what they sound like. If you want a simple test as to whether or not a volume is a removable drive (e.g. a USB hard disk), check for NSURLVolumeIsInternalKey being false (this is what Finder does)</li>
          ...
          <section id="eject">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Unmounts and ejects a volume</p>
<p>Parameters:</p>
<ul>
        ...
        <h4 class="documentation-section">Constructors</h4>
          <section id="new">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Creates a watcher object for volume events</p>
<p>Parameters:</p>
<ul>
        ...
        <h4 class="documentation-section">Methods</h4>
          <section id="start">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Starts the volume watcher</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>An <code>hs.fs.volume</code> object</li>
          ...
          <section id="stop">
            ...
            <table>
              ...
              <tr>
                <th>Description</th>
                <td><p>Stops the volume watcher</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
