...
#### [HINTS](#hints)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.HINTS` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Variable                                                                                         |
...
#### [ui](#ui)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.ui` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Variable                                                                                         |
...
#### [adjustWindow](#adjustwindow)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.adjustWindow(fn, window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [get](#get)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.get(win) -> cell` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getCell](#getcell)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.getCell(cell, screen) -> hs.geometry` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getGrid](#getgrid)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.getGrid(screen) -> hs.geometry size` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getGridFrame](#getgridframe)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.getGridFrame(screen) -> hs.geometry rect` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [hide](#hide)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.hide()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [maximizeWindow](#maximizewindow)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.maximizeWindow(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pushWindowDown](#pushwindowdown)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.pushWindowDown(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pushWindowLeft](#pushwindowleft)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.pushWindowLeft(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pushWindowRight](#pushwindowright)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.pushWindowRight(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [pushWindowUp](#pushwindowup)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.pushWindowUp(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [resizeWindowShorter](#resizewindowshorter)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.resizeWindowShorter(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [resizeWindowTaller](#resizewindowtaller)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.resizeWindowTaller(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [resizeWindowThinner](#resizewindowthinner)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.resizeWindowThinner(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [resizeWindowWider](#resizewindowwider)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.resizeWindowWider(window) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [set](#set)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.set(win, cell, screen) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setGrid](#setgrid)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.setGrid(grid,screen,frame) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [setMargins](#setmargins)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.setMargins(margins) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [show](#show)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.show([exitedCallback][, multipleWindows])` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [snap](#snap)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.snap(win) -> hs.grid` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [toggleShow](#toggleshow)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.grid.toggleShow([exitedCallback][, multipleWindows])` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
