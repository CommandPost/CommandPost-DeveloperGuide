...
#### [commonAttributeKeys[]](#commonattributekeys[])
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight.commonAttributeKeys[]` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
...
#### [definedSearchScopes[]](#definedsearchscopes[])
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight.definedSearchScopes[]` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constant                                                                                         |
...
#### [new](#new)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight.new() -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [newWithin](#newwithin)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight.newWithin(spotlightObject) -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [callbackMessages](#callbackmessages)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:callbackMessages([messages]) -> table | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [count](#count)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:count() -> integer` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [groupedResults](#groupedresults)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:groupedResults() -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [groupingAttributes](#groupingattributes)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:groupingAttributes([attributes]) -> table | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [isGathering](#isgathering)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:isGathering() -> boolean` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [isRunning](#isrunning)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:isRunning() -> boolean` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [queryString](#querystring)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:queryString(query) -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [resultAtIndex](#resultatindex)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:resultAtIndex(index) -> spotlightItemObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [searchScopes](#searchscopes)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:searchScopes([scope]) -> table | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [setCallback](#setcallback)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:setCallback(fn | nil) -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [sortDescriptors](#sortdescriptors)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:sortDescriptors([attributes]) -> table | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [start](#start)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:start() -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [stop](#stop)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:stop() -> spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [updateInterval](#updateinterval)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:updateInterval([interval]) -> number | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [valueListAttributes](#valuelistattributes)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:valueListAttributes([attributes]) -> table | spotlightObject` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
...
#### [valueLists](#valuelists)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.spotlight:valueLists() -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Method                                                                                         |
