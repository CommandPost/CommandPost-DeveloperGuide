...
#### [concat](#concat)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.concat(table1, table2)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [contains](#contains)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.contains(table, element) -> bool` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [copy](#copy)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.copy(table) -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [each](#each)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.each(table, fn)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [every](#every)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.every(table, fn) -> bool` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [filter](#filter)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.filter(table, fn) -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [find](#find)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.find(table, fn) -> element` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [ieach](#ieach)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.ieach(list, fn)` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [ifilter](#ifilter)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.ifilter(list, fn) -> list` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [imap](#imap)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.imap(list, fn) -> list` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [indexOf](#indexof)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.indexOf(table, element) -> number or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [map](#map)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.map(table, fn) -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [mapCat](#mapcat)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.mapCat(table, fn) -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [reduce](#reduce)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.reduce(table, fn) -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [some](#some)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.some(table, fn) -> bool` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [split](#split)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.split(sString, sSeparator [, nMax] [, bPlain]) -> { array }` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [cycle](#cycle)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.cycle(table) -> fn()` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [partial](#partial)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.partial(fn, ...) -> fn'` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [sequence](#sequence)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.sequence(...) -> fn` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [sortByKeyValues](#sortbykeyvalues)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.sortByKeyValues(table[ , function]) -> function` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
...
#### [sortByKeys](#sortbykeys)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.fnutils.sortByKeys(table[ , function]) -> function` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Constructor                                                                                         |
