...
#### [amperage](#amperage)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.amperage() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [capacity](#capacity)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.capacity() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [cycles](#cycles)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.cycles() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [designCapacity](#designcapacity)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.designCapacity() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [getAll](#getall)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.getAll() -> table` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [health](#health)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.health() -> string` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [healthCondition](#healthcondition)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.healthCondition() -> string or nil` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isCharged](#ischarged)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.isCharged() -> boolean` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isCharging](#ischarging)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.isCharging() -> boolean` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [isFinishingCharge](#isfinishingcharge)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.isFinishingCharge() -> boolean or string` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [maxCapacity](#maxcapacity)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.maxCapacity() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [name](#name)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.name() -> string` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [percentage](#percentage)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.percentage() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [powerSource](#powersource)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.powerSource() -> string` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [psuSerial](#psuserial)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.psuSerial() -> integer` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [timeRemaining](#timeremaining)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.timeRemaining() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [timeToFullCharge](#timetofullcharge)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.timeToFullCharge() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [voltage](#voltage)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.voltage() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
...
#### [watts](#watts)
| <span style="font-align: left;">**Signature**</span> | <span style="font-align: left;">`hs.battery.watts() -> number` </span>                                                |
| -----------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| **Type**                                             | Function                                                                                         |
