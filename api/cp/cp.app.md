...
| **Parameters**                                       | <ul><li>`waitSeconds`    - If povided, the number of seconds to wait until the launch completes. If `nil`, it will return immediately.</li></ul> |
| **Returns**                                          | <ul><li>The `cp.app` instance.</li></ul>          |
...
| **Parameters**                                       | <ul><li>* None</li></ul> |
| **Returns**                                          | <ul><li>* The `cp.app.menu` for the `cp.app` instance.</li></ul>          |
