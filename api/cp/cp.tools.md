...
| **Parameters**                                       | <ul><li>point - A point-table containing the absolute x and y co-ordinates to move the mouse pointer to</li></ul><ul><li>delay - The optional delay between multiple mouse clicks</li></ul>   |
...
| **Parameters**                                       | <ul><li>str       - String to analysis</li></ul><ul><li>ending    - End of string to compare against</li></ul>   |
...
| **Parameters**                                       | <ul><li><code>rootPath</code> - The root path (should already exist).</li></ul><ul><li><code>...</code>      - The list of path steps to create</li></ul>   |
...
| **Parameters**                                       | <ul><li>input - either a string or a table of strings of commands you want to execute</li></ul><ul><li>stopOnError - an optional variable that stops processing multiple commands when an individual commands returns an error</li></ul>   |
...
| **Parameters**                                       | <ul><li>input - The path</li></ul><ul><li>removeExtension - (optional) set to <code>true</code> if the file extension should be removed</li></ul>   |
...
| **Parameters**                                       | <ul><li>tbl - the table you want to sort</li></ul><ul><li>sortFunction - the function you want to use to sort the table</li></ul>   |
...
| **Parameters**                                       | <ul><li>point - A point-table containing the absolute x and y co-ordinates to move the mouse pointer to</li></ul><ul><li>delay - The optional delay between multiple mouse clicks</li></ul><ul><li>clickNumber - The optional number of times you want to perform the click.</li></ul>   |
| **Returns**                                          | <ul><li>None</li></ul>            |
...
| **Parameters**                                       | <ul><li>target   - The target table</li></ul><ul><li>...      - Any other tables you want to merge into target</li></ul>   |
| **Returns**                                          | <ul><li>Table</li></ul>            |
...
| **Parameters**                                       | <ul><li>point - A point-table containing the absolute x and y co-ordinates to move the mouse pointer to</li></ul><ul><li>fn - A function you want to perform</li></ul>   |
| **Returns**                                          | <ul><li>None</li></ul>            |
...
| **Parameters**                                       | <ul><li>table - the table you want to check</li></ul><ul><li>element - the string you want to remove</li></ul>   |
...
| **Parameters**                                       | <ul><li><code>path</code>        - The absolute path to remove</li></ul><ul><li><code>recursive</code>   - If <code>true</code>, the contents of the directory will be removed first.</li></ul>   |
...
| **Parameters**                                       | <ul><li>num - The number you want to round</li></ul><ul><li>numDecimalPlaces - How many numbers of decimal places (defaults to 0)</li></ul>   |
...
| **Parameters**                                       | <ul><li>value - a string you want to make safe</li></ul><ul><li>defaultValue - the optional default filename to use if the value is not valid</li></ul>   |
...
| **Parameters**                                       | <ul><li>t     - The table to process</li></ul><ul><li>order - The function of how to sort the table.</li></ul>   |
...
| **Parameters**                                       | <ul><li>str - The string to split</li></ul><ul><li>pat - The pattern</li></ul>   |
| **Returns**                                          | <ul><li>Table</li></ul>            |
...
| **Parameters**                                       | <ul><li>maxLength - The length of the string as a number</li></ul><ul><li>optionalEnd - A string that is applied to the end of the input string if the input string is larger than the maximum length.</li></ul>   |
| **Returns**                                          | <ul><li>A string</li></ul>            |
...
| **Parameters**                                       | <ul><li>table - the table you want to check</li></ul><ul><li>element - the element you want to check for</li></ul>   |
