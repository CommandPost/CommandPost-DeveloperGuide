    ...
    <header>
      <h1><a href="cp.ui.axutils.md">docs</a> &raquo; cp.ui.axutils</h1>
      <p>Utility functions to support <code>hs._asm.axuielement</code>.</p>
      ...
      <h3>API Documentation</h3>
        <h4 class="documentation-section">Functions</h4>
          <section id="cache">
            <a name="//apple_ref/cpp/Function/cache" class="dashAnchor"></a>
...
<li>The valid cached value.</li>
          ...
          <section id="childAtIndex">
            <a name="//apple_ref/cpp/Function/childAtIndex" class="dashAnchor"></a>
...
<li>The child, or <code>nil</code> if the index is larger than the number of children.</li>
          ...
          <section id="childFromBottom">
            <a name="//apple_ref/cpp/Function/childFromBottom" class="dashAnchor"></a>
...
<li>The child, or <code>nil</code> if the index is larger than the number of children.</li>
          ...
          <section id="childFromLeft">
            <a name="//apple_ref/cpp/Function/childFromLeft" class="dashAnchor"></a>
...
<li>The child, or <code>nil</code> if the index is larger than the number of children.</li>
          ...
          <section id="childFromRight">
            <a name="//apple_ref/cpp/Function/childFromRight" class="dashAnchor"></a>
...
<li>The child, or <code>nil</code> if the index is larger than the number of children.</li>
          ...
          <section id="childFromTop">
            <a name="//apple_ref/cpp/Function/childFromTop" class="dashAnchor"></a>
...
<li>The child, or <code>nil</code> if the index is larger than the number of children.</li>
          ...
          <section id="childMatching">
            <a name="//apple_ref/cpp/Function/childMatching" class="dashAnchor"></a>
...
<li>The first matching child, or nil if none was found</li>
          ...
          <section id="children">
            <a name="//apple_ref/cpp/Function/children" class="dashAnchor"></a>
...
<li>the children table, or <code>nil</code>.</li>
          ...
          <section id="childrenMatching">
            <a name="//apple_ref/cpp/Function/childrenMatching" class="dashAnchor"></a>
...
<li>All matching children, or <code>nil</code> if none was found</li>
          ...
          <section id="childrenWith">
            <a name="//apple_ref/cpp/Function/childrenWith" class="dashAnchor"></a>
...
<li>All matching children, or <code>nil</code> if none was found</li>
          ...
          <section id="childrenWithRole">
            <a name="//apple_ref/cpp/Function/childrenWithRole" class="dashAnchor"></a>
...
<li>All matching children, or <code>nil</code> if none was found</li>
          ...
          <section id="childWith">
            <a name="//apple_ref/cpp/Function/childWith" class="dashAnchor"></a>
...
<li>The first matching child, or nil if none was found</li>
          ...
          <section id="childWithDescription">
            <a name="//apple_ref/cpp/Function/childWithDescription" class="dashAnchor"></a>
...
<li>The first matching child, or <code>nil</code> if none was found</li>
          ...
          <section id="childWithID">
            <a name="//apple_ref/cpp/Function/childWithID" class="dashAnchor"></a>
...
<li>The first matching child, or <code>nil</code> if none was found</li>
          ...
          <section id="childWithRole">
            <a name="//apple_ref/cpp/Function/childWithRole" class="dashAnchor"></a>
...
<li>The first matching child, or <code>nil</code> if none was found</li>
          ...
          <section id="compareBottomToTop">
            <a name="//apple_ref/cpp/Function/compareBottomToTop" class="dashAnchor"></a>
...
<li><code>true</code> if <code>a</code> is below <code>b</code>.</li>
          ...
          <section id="compareLeftToRight">
            <a name="//apple_ref/cpp/Function/compareLeftToRight" class="dashAnchor"></a>
...
<li><code>true</code> if <code>a</code> is left of <code>b</code>.</li>
          ...
          <section id="compareRightToLeft">
            <a name="//apple_ref/cpp/Function/compareRightToLeft" class="dashAnchor"></a>
...
<li><code>true</code> if <code>a</code> is right of <code>b</code>.</li>
          ...
          <section id="compareTopToBottom">
            <a name="//apple_ref/cpp/Function/compareTopToBottom" class="dashAnchor"></a>
...
<li><code>true</code> if <code>a</code> is above <code>b</code>.</li>
          ...
          <section id="hasAttributeValue">
            <a name="//apple_ref/cpp/Function/hasAttributeValue" class="dashAnchor"></a>
...
<li><code>true</code> if the <code>element</code> has the supplied attribute value, otherwise <code>false</code>.</li>
          ...
          <section id="isValid">
            <a name="//apple_ref/cpp/Function/isValid" class="dashAnchor"></a>
...
<li><code>true</code> if the element is valid.</li>
          ...
          <section id="snapshot">
            <a name="//apple_ref/cpp/Function/snapshot" class="dashAnchor"></a>
