...
| **Parameters**                                       | <ul><li>childrenUI - A table of `hs._asm.axuielement` objects.</li></ul> |
...
| **Parameters**                                       | <ul><li>childUI - The `hs._asm.axuielement` object of the child you want to select.</li></ul> |
...
| **Parameters**                                       | <ul><li>childUI - The `hs._asm.axuielement` object of the child you want to show.</li></ul> |
