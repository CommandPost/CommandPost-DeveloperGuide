...
| **Parameters**                                       | <ul><li>inputA - table of modifiers</li></ul><ul><li>inputB - table of modifiers</li></ul>   |
...
| **Parameters**                                       | <ul><li>id - The ID of the command you want to get.</li></ul><ul><li>commandSet - A table containing an entire Command Set.</li></ul>   |
