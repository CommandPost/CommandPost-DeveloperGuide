    ...
    <header>
      <h1><a href="cp.config.dockIconClickCallback.md">docs</a> &raquo; cp.config.dockIconClickCallback</h1>
      <p>Callback which triggers when the CommandPost Dock Icon is clicked</p>
