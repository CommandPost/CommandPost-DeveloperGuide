...
| **Parameters**                                       | <ul><br /><li>parent    - The parent object.* type      - The type of color wheel. Must be one of the <code>ColorWheel.TYPE</code> values.</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>A new <code>ColorWheel</code> instance.</li><br /></ul>                                           |
...
| **Returns**                                          | <ul><br /><li>The brightness <code>ValueIndicator</code> instance.</li><br /></ul>                                           |
...
| **Returns**                                          | <ul><br /><li>The <code>ColorWheel</code> instance.</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>None</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The ColorWheel instance.</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>None</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The reset <code>Button</code> instance.</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>None</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The saturation <code>ValueIndicator</code> instance.</li><br /></ul>                                           |
