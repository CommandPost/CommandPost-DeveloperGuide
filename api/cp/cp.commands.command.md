...
| **Parameters**                                       | <ul><li><code>modifiers</code>  - (optional) The table containing names of required modifiers.</li></ul><ul><li><code>keyCode</code>    - (optional) The key code that will activate the command, with no modifiers.</li></ul>   |
...
| **Parameters**                                       | <ul><li><code>id</code>     - the unique identifier for the command. E.g. 'cpCustomCommand'</li></ul><ul><li><code>parent</code> - The parent group.</li></ul>   |
