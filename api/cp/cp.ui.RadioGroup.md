    ...
    <header>
      <h1><a href="cp.ui.RadioGroup.md">docs</a> &raquo; cp.ui.RadioGroup</h1>
      <p>Represents an <code>AXRadioGroup</code>, providing utility methods.</p>
...
<li><code>true</code> if the element is a RadioGroup.</li>
        ...
        <h4 class="documentation-section">Fields</h4>
          <section id="optionCount">
            <a name="//apple_ref/cpp/Field/optionCount" class="dashAnchor"></a>
          ...
          <section id="selectedOption">
            <a name="//apple_ref/cpp/Field/selectedOption" class="dashAnchor"></a>
...
<li>The new <code>RadioGroup</code> instance.</li>
          ...
          <section id="nextOption">
            <a name="//apple_ref/cpp/Method/nextOption" class="dashAnchor"></a>
...
<li>The parent object.</li>
          ...
          <section id="previousOption">
            <a name="//apple_ref/cpp/Method/previousOption" class="dashAnchor"></a>
