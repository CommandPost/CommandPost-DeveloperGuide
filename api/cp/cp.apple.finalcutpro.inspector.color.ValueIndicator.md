...
| **Parameters**                                       | <ul><li><code>parent</code>         - The parent table.</li></ul><ul><li><code>finderFn</code>       - The function which returns the <code>axuielement</code>.</li></ul><ul><li><code>minValue</code>       - The minimum value allowed for the value.</li></ul><ul><li><code>maxValue</code>       - The maximum value allowed for the value.</li></ul><ul><li><code>toAXValueFn</code>    - The function which will convert the user value to the actual AXValue.</li></ul><ul><li><code>fromAXValueFn</code>  - The function which will convert the current AXValue to a user value.</li></ul>   |
