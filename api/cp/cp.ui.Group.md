    ...
    <header>
      <h1><a href="cp.ui.Group.md">docs</a> &raquo; cp.ui.Group</h1>
      <p>UI Group.</p>
        ...
        <h4 class="documentation-section">Functions</h4>
          <section id="matches">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>cp.ui.Group.matches(element) -&gt; boolean</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
        ...
        <h4 class="documentation-section">Constructors</h4>
          <section id="new">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>cp.ui.Group.new(parent, finderFn) -&gt; Alert</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constructor</td>
...
<p>Returns:</p>
<ul>
<li>A new <code>Group</code> object.</li>
</ul>
</td>
              </tr>
            </table>
        ...
        <h4 class="documentation-section">Methods</h4>
          <section id="app">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>cp.ui.Group:app() -&gt; App</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>App</li>
          ...
          <section id="parent">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>cp.ui.Group:parent() -&gt; parent</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
