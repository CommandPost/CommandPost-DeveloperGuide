...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`cell`	- The cell to check</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">The combined text value of the cell.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`cell`	- The cell to check</li><li markdown="1">`value`	- The text value to compare.</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">`true` if the cell text value equals the provided `value`.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`row`		- The row to disclose</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">`true` if the row is disclosable and is now expanded.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`rows`		- The array of rows to process.</li><li markdown="1">`names`		- The array of names to navigate down</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">The row that was visited, or `nil` if not.</li></ul>          |
...
| **Returns**                                          | <ul markdown="1"><li markdown="1">`true` if the thing is a `Table` instance.</li></ul>          |
...
| **Returns**                                          | <ul markdown="1"><li markdown="1">`true` if it matches.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`element`	- The element to check</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">`true` if the element is a valid content element.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`parent`		- The parent object.</li><li markdown="1">`finder`		- A function which will return the `axuielement` that this table represents.</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">A new `Table` instance.</li></ul>          |
...
| **Returns**                                          | <ul markdown="1"><li markdown="1">Table of column headers. If the table is visible but no column headers are defined, an empty table is returned. If it's not visible, `nil` is returned.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowUI - A table of `hs._asm.axuielement` objects for the rows you want to deselect.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowUI - The `hs._asm.axuielement` object of the row you want to deselect.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">index - The index of the row you wish to deselect.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowNumber - The row number.</li><li markdown="1">columnId - The Column ID.</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">A `hs._asm.axuielement` object for the cell, or `nil` if the cell cannot be found.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">id - The `AXIdentifier` of the column index you want to find.</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">A column index as a number, or `nil` if no index can be found.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">layout - A table containing the Table layout settings - created using `cp.ui.Table:saveLayout()`.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">None</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">The table's parent.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">`filterFn`	- An optional function that will be called to check if individual rows should be included. If not provided, all rows are returned.</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">Table of rows. If the table is visible but no rows match, it will be an empty table, otherwise it will be `nil`.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">None</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">A table containing the current Table Layout.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowUI - A table of `hs._asm.axuielement` objects for the rows you want to select.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">None</li></ul> |
| **Returns**                                          | <ul markdown="1"><li markdown="1">Table of `hs._asm.axuielement` objects, or `nil` if none could be found.</li></ul>          |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowUI - The `hs._asm.axuielement` object of the row you want to select.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">index - The index of the row you wish to select.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">rowUI - The `hs._asm.axuielement` object of the row you want to show.</li></ul> |
...
| **Parameters**                                       | <ul markdown="1"><li markdown="1">index - The index of the row you wish to show.</li></ul> |
