...
| **Parameters**                                       | <ul><li>whatMessage - The message you want to display as a string * fileType - The filetype you wish to display * defaultLocation - Path to Default Location</li></ul> |
...
| **Parameters**                                       | <ul><li>whatMessage - The message you want to display as a string * defaultLocation - Path to Default Location</li></ul> |
...
| **Parameters**                                       | <ul><li>dialogPrompt - The message you want to display as a string * listOptions - A table containing all the options you want to include in the list as strings * defaultItems - A table containing all the options you want select by default in the list as strings</li></ul> |
...
| **Parameters**                                       | <ul><li>whatMessage - The message you want to display as a string * whatErrorMessage - The error message that appears if a user input is invalid * defaultAnswer - The default value of the text box</li></ul> |
...
| **Parameters**                                       | <ul><li>whatMessage - The message you want to display as a string * whatErrorMessage - The error message that appears if a user input is invalid * defaultAnswer - The default value of the text box * validationFn - A function that takes one parameter and returns a boolean value</li></ul> |
| **Returns**                                          | <ul><li><code>false</code> if cancelled if pressed otherwise the text entered in the dialog box</li></ul> |
| **Notes**                                            | <ul><li>IMPORTANT: This should no longer be used in favour of <code>hs.dialog.textPrompt</code></li></ul> |
...
| **Parameters**                                       | <ul><li>whatMessage - The message you want to display as a string * informativeText - Informative text.</li></ul> |
