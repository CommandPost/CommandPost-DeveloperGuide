...
| **Parameters**                                       | <ul><li>textPattern   - The text pattern to check. * plain         - If <code>true</code>, the text will be compared exactly, otherwise it will be considered to be a pattern. Defaults to <code>false</code>.</li></ul> |
...
| **Parameters**                                       | <ul><li>None</li></ul> |
| **Returns**                                          | <ul><li>The <code>Alert</code> object. * <code>true</code> if successful, otherwise <code>false</code>.</li></ul> |
