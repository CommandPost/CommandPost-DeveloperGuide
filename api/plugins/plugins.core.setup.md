...
| **Parameters**                                       | <ul><br /><li><code>newPanel</code>   - The panel to add.</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The manager.</li><br /></ul>                                           |
...
| **Returns**                                          | <ul><br /><li>The current panel as a string</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>env - The plugin environment table</li><br /></ul>                                        |
...
| **Parameters**                                       | <ul><br /><li>script - The JavaScript you want to inject as a string.</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>None</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>None</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li><code>true</code> if there was another panel to move to, or <code>false</code> if no panels remain.</li><br /></ul>                                           |
