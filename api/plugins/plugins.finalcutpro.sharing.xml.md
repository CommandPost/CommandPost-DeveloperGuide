    ...
    <header>
      <h1><a href="plugins.finalcutpro.sharing.xml.md">docs</a> &raquo; plugins.finalcutpro.sharing.xml</h1>
      <p>Shared XML Plugin.</p>
      ...
      <h3>API Documentation</h3>
        <h4 class="documentation-section">Functions</h4>
          <section id="clearSharedFiles">
            <a name="//apple_ref/cpp/Function/clearSharedFiles" class="dashAnchor"></a>
...
<li>None</li>
          ...
          <section id="listFilesMenu">
            <a name="//apple_ref/cpp/Function/listFilesMenu" class="dashAnchor"></a>
...
<li>None</li>
          ...
          <section id="shareXML">
            <a name="//apple_ref/cpp/Function/shareXML" class="dashAnchor"></a>
