    ...
    <header>
      <h1><a href="plugins.core.tangent.manager.menu.md">docs</a> &raquo; plugins.core.tangent.manager.menu</h1>
      <p>Represents a Tangent Menu. Menus are controls that have a fixed set of
...
<li>The <code>parameter</code> instance.</li>
          ...
          <section id="onNext">
            <a name="//apple_ref/cpp/Method/onNext" class="dashAnchor"></a>
...
<li>The <code>parameter</code> instance.</li>
          ...
          <section id="onPrev">
            <a name="//apple_ref/cpp/Method/onPrev" class="dashAnchor"></a>
...
<li>The parent.</li>
          ...
          <section id="prev">
            <a name="//apple_ref/cpp/Method/prev" class="dashAnchor"></a>
