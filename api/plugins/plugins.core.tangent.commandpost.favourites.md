...
| **Parameters**                                       | <ul><li>tangentManager - Tangent Manager Plugin</li></ul><ul><li>actionManager - Action Manager Plugin</li></ul><ul><li>cpGroup - CommandPost Group</li></ul>   |
| **Returns**                                          | <ul><li>None</li></ul>            |
...
| **Parameters**                                       | <ul><li>buttonID - The button ID as number.</li></ul><ul><li>actionTitle - The action title as string.</li></ul><ul><li>handlerID - The handler ID as string.</li></ul><ul><li>action - The action table.</li></ul>   |
| **Returns**                                          | <ul><li>None</li></ul>            |
