...
| **Parameters**                                       | <ul><li>mode - "timeline" or "browser". If no mode is specified then we will determine</li></ul><pre><code>      the mode based off the mouse location.</code></pre>   |
