    ...
    <header>
      <h1><a href="plugins.finalcutpro.tangent.view.md">docs</a> &raquo; plugins.finalcutpro.tangent.view</h1>
        ...
        <h4 class="documentation-section">Constants</h4>
          <section id="group">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.finalcutpro.tangent.view.group</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
        ...
        <h4 class="documentation-section">Functions</h4>
          <section id="init">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.finalcutpro.tangent.view.init() -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
