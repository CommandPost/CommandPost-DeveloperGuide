...
| **Parameters**                                       | <ul><br /><li>other - The item to check</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li><code>true</code> if is a mode otherwise <code>false</code></li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>activateFn     - The function to call when the Tangent requests the mode change.</li><br /></ul>                                        |
...
| **Parameters**                                       | <ul><br /><li>deactivateFn     - The function to call when the Tangent requests the mode change.</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The <code>parameter</code> instance.</li><br /></ul>                                           |
...
| **Parameters**                                       | <ul><br /><li>None</li><br /></ul>                                        |
| **Returns**                                          | <ul><br /><li>The <code>xml</code> for the Mode.</li><br /></ul>                                           |
