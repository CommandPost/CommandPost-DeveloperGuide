...
| **Parameters**                                       | <ul><li><code>action</code>  - A table of parameters, matching the following:</li></ul><pre><code>* `group`   - The Command Group ID</code></pre><pre><code>* `id`      - The specific Command ID within the group.</code></pre>   |
