    ...
    <header>
      <h1><a href="plugins.core.preferences.manager.panel.md">docs</a> &raquo; plugins.core.preferences.manager.panel</h1>
      <p>CommandPost Preferences Panel.</p>
        ...
        <h4 class="documentation-section">Constants</h4>
          <section id="DEFAULT_PRIORITY">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel.DEFAULT_PRIORITY -&gt; number</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="HANDLER_PRIORITY">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel.HANDLER_PRIORITY -&gt; number</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
        ...
        <h4 class="documentation-section">Constructors</h4>
          <section id="new">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel.new(priority, id) -&gt; cp.core.preferences.manager.panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constructor</td>
        ...
        <h4 class="documentation-section">Methods</h4>
          <section id="addButton">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addButton(params) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
** <code>onclick</code>   - the function to execute when the button is clicked. The function should have the signature of <code>function(id, value)</code>, where <code>id</code> is the id of the button that was clicked, and <code>value</code> is the value of the button.</li>
          ...
          <section id="addCheckbox">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addCheckbox(priority, params) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
** <code>class</code>      - (optional) the CSS class list to apply to the checkbox.</li>
          ...
          <section id="addContent">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addContent(priority, content[, escaped]) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel.</li>
          ...
          <section id="addHandler">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addHandler(event, id, handlerFn, keys) -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>None</li>
          ...
          <section id="addHeading">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addHeading(text) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel object.</li>
          ...
          <section id="addParagraph">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addParagraph(content[, escaped[, class]]) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel object.</li>
          ...
          <section id="addPassword">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addPassword(params) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel object.</li>
          ...
          <section id="addSelect">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addSelect(params) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel object.</li>
          ...
          <section id="addTextbox">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:addTextbox(params) -&gt; panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
...
<li>The panel object.</li>
          ...
          <section id="getToolbarItem">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.panel:getToolbarItem() -&gt; table</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Method</td>
