...
| **Type**                                             | Method                                                                                         |
| **Description**                                      | Adds a Paragraph to the panel                                                                                         |
| **Parameters**                                       | <ul><li>content - The content value</li></ul><ul><li>default - The default value to display if the <code>content</code> is <code>nil</code>. It will be displayed with a different style.</li></ul>   |
| **Returns**                                          | <ul><li>The panel object.</li></ul>            |
