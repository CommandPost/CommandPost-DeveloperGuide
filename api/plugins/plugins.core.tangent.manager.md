...
| **Parameters**                                       |  * None                                       |
| **Returns**                                          |  * `true` if mapping files are installed otherwise `false`                                                |
...
| **Parameters**                                       | * id    - The ID to find.                                       |
| **Returns**                                          | * The `mode`, or `nil`.                                                |
...
| **Parameters**                                       | * aProp     - The `cp.prop` that may interrupt the connection.                                       |
| **Returns**                                          | * Nothing.                                                |
...
| **Parameters**                                       |  * None                                       |
| **Returns**                                          |  *  `true` if successfully created otherwise `false` if an error occurred. *  If an error occurs an error message will also be returned as a string.                                                |
