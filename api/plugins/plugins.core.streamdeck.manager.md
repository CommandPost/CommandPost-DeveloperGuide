    ...
    <header>
      <h1><a href="plugins.core.streamdeck.manager.md">docs</a> &raquo; plugins.core.streamdeck.manager</h1>
      <p>Elgato Stream Deck Manager Plugin.</p>
...
<li>Returns the active group or <code>manager.defaultGroup</code> as a string.</li>
          ...
          <section id="appWatcherCallback">
            <a name="//apple_ref/cpp/Function/appWatcherCallback" class="dashAnchor"></a>
...
<li>None</li>
          ...
          <section id="buttonCallback">
            <a name="//apple_ref/cpp/Function/buttonCallback" class="dashAnchor"></a>
