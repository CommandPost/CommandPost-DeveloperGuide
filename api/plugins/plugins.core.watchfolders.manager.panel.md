...
| **Parameters**                                       | <ul><li><code>priority</code> - The priority number for the button.</li></ul><ul><li><code>params</code> - The set of parameters for the button.</li></ul>   |
...
| **Parameters**                                       | <ul><li>event - The JavaScript event as string</li></ul><ul><li>id - The ID as string</li></ul><ul><li>handlerFn - The handler function</li></ul><ul><li>keys - Table of keys</li></ul>   |
| **Returns**                                          | <ul><li>The panel object</li></ul>            |
...
| **Parameters**                                       | <ul><li><code>priority</code> - The priority number for the heading.</li></ul><ul><li><code>text</code> - The content of the heading as a string.</li></ul><ul><li><code>level</code> - The level of the heading.</li></ul>   |
| **Returns**                                          | <ul><li>The panel object</li></ul>            |
...
| **Parameters**                                       | <ul><li><code>priority</code> - The priority number for the paragraph.</li></ul><ul><li><code>content</code> - The content you want to include as a string.</li></ul><ul><li><code>escaped</code> - Whether or not the HTML is escaped as a boolean.</li></ul><ul><li><code>class</code> - The class name as a string.</li></ul>   |
| **Returns**                                          | <ul><li>The panel object</li></ul>            |
...
| **Parameters**                                       | <ul><li><code>priority</code>   - The priority number for the password.</li></ul><ul><li><code>params</code>     - The set of parameters for the password.</li></ul>   |
| **Returns**                                          | <ul><li>The panel.</li></ul>            |
...
| **Parameters**                                       | <ul><li><code>priority</code> - The priority number for the select.</li></ul><ul><li><code>params</code> - The set of parameters for the select.</li></ul>   |
| **Returns**                                          | <ul><li>The panel.</li></ul>            |
...
| **Parameters**                                       | <ul><li><code>priority</code>   - The priority number for the textbox.</li></ul><ul><li><code>params</code>     - The set of parameters for the textbox.</li></ul>   |
| **Returns**                                          | <ul><li>The panel.</li></ul>            |
