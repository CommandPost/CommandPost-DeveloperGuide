    ...
    <header>
      <h1><a href="plugins.core.tangent.manager.group.md">docs</a> &raquo; plugins.core.tangent.manager.group</h1>
      <p>Represents a Tangent Group. Groups can also be used to enable/disable multiple
Parameters/Actions/Menus by enabling/disabling the containing group.</p>
...
<li>The new <code>action</code></li>
          ...
          <section id="binding">
            <a name="//apple_ref/cpp/Method/binding" class="dashAnchor"></a>
