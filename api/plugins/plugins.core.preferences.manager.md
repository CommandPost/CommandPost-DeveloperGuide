    ...
    <header>
      <h1><a href="plugins.core.preferences.manager.md">docs</a> &raquo; plugins.core.preferences.manager</h1>
      <p>Manager for the CommandPost Preferences Window.</p>

      </header>
        <h3>Submodules</h3>
        <ul>
        <li><a href="plugins.core.preferences.manager.panel.html">plugins.core.preferences.manager.panel</a></li>
        </ul>
      <h3>API Overview</h3>
      <ul>
        ...
        <h4 class="documentation-section">Constants</h4>
          <section id="DEFAULT_HEIGHT">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.DEFAULT_HEIGHT -&gt; number</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="DEFAULT_TITLE">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.DEFAULT_TITLE -&gt; string</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="DEFAULT_WIDTH">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.DEFAULT_WIDTH -&gt; number</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="DEFAULT_WINDOW_STYLE">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.DEFAULT_WINDOW_STYLE -&gt; table</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="lastTab">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.lastTab</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="position">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.position</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
          ...
          <section id="WEBVIEW_LABEL">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.WEBVIEW_LABEL -&gt; string</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Constant</td>
        ...
        <h4 class="documentation-section">Variables</h4>
          <section id="_handlers">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager._handlers -&gt; table</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Variable</td>
          ...
          <section id="_panels">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager._panels -&gt; table</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Variable</td>
        ...
        <h4 class="documentation-section">Functions</h4>
          <section id="addHandler">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.addHandler(id, handlerFn) -&gt; string</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>Nothing</li>
          ...
          <section id="addPanel">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.addPanel(params) -&gt; plugins.core.preferences.manager.panel</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<strong> <code>tooltip</code>       - The human-readable details for the toolbar icon when the mouse is hovering over it.</strong> <code>closeFn</code>       - A callback function that's triggered when the Preferences window is closed.</li>
          ...
          <section id="focus">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.focus() -&gt; boolean</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
              ...
              <tr>
                <th>Description</th>
                <td><p>Puts focus on the Preferences Window.</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li><code>true</code> if successful or otherwise <code>false</code>.</li>
          ...
          <section id="getHandler">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.getHandler(id) -&gt; string</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>Table</li>
          ...
          <section id="getLabel">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.getLabel() -&gt; string</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>The Webview label as a string.</li>
          ...
          <section id="getWebview">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.getWebview() -&gt; hs.webview</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>A <code>hs.webview</code></li>
          ...
          <section id="hide">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.hide() -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
              ...
              <tr>
                <th>Description</th>
                <td><p>Hides the Preferences Window.</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>None</li>
          ...
          <section id="init">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.init() -&gt; nothing</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>Nothing</li>
          ...
          <section id="injectScript">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.injectScript(script) -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
              ...
              <tr>
                <th>Description</th>
                <td><p>Injects JavaScript into the Preferences Webview.</p>
<p>Parameters:</p>
<ul>
...
<li>None</li>
          ...
          <section id="maxPanelHeight">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.maxPanelHeight() -&gt; number</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>The maximum panel height.</li>
          ...
          <section id="new">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.new() -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>None</li>
          ...
          <section id="refresh">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.refresh() -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
              ...
              <tr>
                <th>Description</th>
                <td><p>Refreshes the Preferences Window.</p>
<p>Parameters:</p>
<ul>
<li>None</li>
</ul>
...
<li>None</li>
          ...
          <section id="selectPanel">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.selectPanel(id) -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>None</li>
          ...
          <section id="setPanelRenderer">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.setPanelRenderer(renderer) -&gt; none</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
...
<li>None</li>
          ...
          <section id="show">
            ...
            <table>
              <tr>
                <th>Signature</th>
                <td><code>plugins.core.preferences.manager.show() -&gt; boolean</code></td>
              </tr>
              <tr>
                <th>Type</th>
                <td>Function</td>
