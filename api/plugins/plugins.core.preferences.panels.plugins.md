...
<h4 class="documentation-section">Constants</h4>
  <section id="SETTINGS_DISABLED">
	...
	<table>
	  <tr>
		<th>Signature</th>
		<td><code>plugins.core.preferences.panels.plugins.SETTINGS_DISABLED</code></td>
	  </tr>
	  <tr>
		<th>Type</th>
		<td>Constant</td>
...
<h4 class="documentation-section">Functions</h4>
  <section id="init">
	...
	<table>
	  <tr>
		<th>Signature</th>
		<td><code>plugins.core.preferences.panels.plugins.init() -&gt; none</code></td>
	  </tr>
	  <tr>
		<th>Type</th>
		<td>Function</td>
...
<p>Parameters:</p>
<ul>
<li>deps - The plugin dependencies.</li>
